  ...
  function DashboardFunction() {
    ...
    axios
      ...
      .then(
        axios.spread((...res) => {
          setData({
            totalUsers: res[0].data.total,
            totalActiveUsers: res[1].data.total,
            totalGenerateWallets: res[2].data.total,
            totalVerifiedUsers: res[3].data.total,
            totalTransactions: res[4].data.total,
            totalActiveWallets: res[5].data.total,
          });
          setStatus(true);
        })
      )
  ...
  return (
    <adminContext.Provider value={data}>
      ...
      <CardDashboard
        ...
        totalActiveUsers={
          data === undefined || data === null ? "0" : data.totalActiveUsers
        }
        totalGenerateWallets={
          data === undefined || data === null ? "0" : data.totalGenerateWallets
        }
        totalVerifiedUsers={
          data === undefined || data === null ? "0" : data.totalVerifiedUsers
        }
        totalTransactions={
          data === undefined || data === null ? "0" : data.totalTransactions
        }
        totalActiveWallets={
          data === undefined || data === null ? "0" : data.totalActiveWallets
        }
      />
      ...
      <div className="row">
        <div className="col-lg-3">
          <CardDashboardComponent
            ...
            totalCount={
              props.totalUsers === undefined ? "Loading ..." : props.totalUsers
            } /*====== Total Count Data ======*/
        ...
        <div className="col-lg-3">
          <CardDashboardComponent
            ...
            totalCount={
              props.totalActiveUsers === undefined
                ? "Loading ..."
        ...
        <div className="col-lg-3">
          <CardDashboardComponent
            ...
            totalCount={
              props.totalVerifiedUsers === undefined
                ? "Loading ..."
        ...
        <div className="col-lg-3">
          <CardDashboardComponent
            ...
            totalCount={
              props.totalTransactions === undefined
                ? "Loading ..."
      ...
      <div className="row">
        ...
        <div className="col-lg-3">
          <CardDashboardComponent
            ...
            totalCount={
              props.totalGenerateWallets === undefined
                ? "Loading ..."
                : props.totalGenerateWallets
            } /*====== Total Count Data ======*/
            upDownClass="mdi mdi-trending-up" /*====== Set Icon Up or Down Total Data ======*/
            upDownText="text-success" /*====== Set Color For Icon Up or Down (text-success = Green Color) / (text-danger = Red Color) ======*/
        ...
        <div className="col-lg-3">
          <CardDashboardComponent
            ...
            totalCount={
              props.totalActiveWallets === undefined
                ? "Loading ..."
                : props.totalActiveWallets
            } /*====== Total Count Data ======*/
            upDownClass="mdi mdi-trending-down" /*====== Set Icon Up or Down Total Data ======*/
            upDownText="text-danger" /*====== Set Color For Icon Up or Down (text-success = Green Color) / (text-danger = Red Color) ======*/
